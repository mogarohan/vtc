...
export default function PlasticIndustryPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg text-slate-300 max-w-xl mb-12 leading-relaxed font-light">
              From high-performance engineering resins to sustainable
              bio-plastics, we provide the molecular foundation for modern
              manufacturing.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {sectors.map((sector, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group p-10 bg-slate-50 border border-slate-100 rounded-3xl hover:bg-white hover:shadow-2xl hover:border-blue-100 transition-all duration-500"
                >
      ...
      <section className="py-14 bg-slate-50 px-6 border-y border-slate-100">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
              ...
              <div className="flex gap-4 p-6 bg-white rounded-2xl shadow-sm border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Real-time pressure and temperature sensors ensure every part
                    meets the blueprint exactly.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-6 bg-white rounded-2xl shadow-sm border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Our machinery is optimized for the latest biodegradable and
          ...
          <div className="flex-1 bg-white p-10 rounded-[3rem] shadow-2xl border border-blue-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 p-10 opacity-5 text-blue-900">
              <FlaskConical size={120} />
            </div>
            <h4 className="font-bold text-blue-900 mb-6 flex items-center gap-2 uppercase tracking-widest text-xs">
              <span className="w-3 h-3 bg-blue-600 rounded-full"></span> Live
              Mold Analysis
            </h4>
