        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg text-slate-400 max-w-xl mb-12 leading-relaxed font-light">
              We specialize in the engineering of advanced fibers and
              high-density fabrics. Our mills combine heritage craftsmanship
              with Industry 4.0 automation.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1 relative">
            <div className="bg-slate-900 p-10 rounded-[3rem] shadow-2xl border border-slate-800">
              <h4 className="text-blue-400 font-bold uppercase text-xs tracking-[0.3em] mb-8">
                System Analytics
              </h4>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Automated optical inspection systems scan every centimeter
                    of fabric for weaving irregularities.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Go from fiber concept to physical sample in under 72 hours
                    with our digital loom integration.
                  </p>
                </div>
              </div>
            </div>
