...
const AutomobileInsurancePage = () => {
  ...
  const protections = [
    { title: "Property & Business Interruption", icon: <ShieldCheck size={28} />, image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&q=80&w=600" },
    { title: "Product Liability & Recall", icon: <Car size={28} />, image: "https://images.unsplash.com/photo-1553440592-56a85322f0ad?auto=format&fit=crop&q=80&w=600" },
    { title: "Professional Indemnity", icon: <UserCheck size={28} />, image: "https://images.unsplash.com/photo-1454165833767-131f3695382f?auto=format&fit=crop&q=80&w=600" },
    { title: "Cyber Insurance", icon: <Lock size={28} />, image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=600" },
    { title: "Marine & Transit", icon: <Anchor size={28} />, image: "https://images.unsplash.com/photo-1516216628859-9bccecad13ca?auto=format&fit=crop&q=80&w=600" },
  ];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-black text-[#070B7F] mb-6 tracking-tighter uppercase leading-tight">
            Automobile & Engineering <br /> <span className="text-blue-600 italic">Insurance</span> Solutions
          </h1>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            className="bg-white/70 backdrop-blur-xl p-10 md:p-16 rounded-[3rem] shadow-2xl border border-white/50 flex flex-col md:row items-center gap-12"
          >
            ...
            <div className="md:w-1/2">
              <div className="flex items-center gap-3 text-blue-600 mb-6">
                <Settings size={32} />
                <h3 className="text-2xl font-bold uppercase tracking-wider italic">The Transformation</h3>
              </div>
              <p className="text-xl md:text-2xl text-slate-900 leading-relaxed font-medium">
                The automobile and engineering sectors are undergoing <span className="text-blue-600 font-black underline decoration-sky-400">unprecedented transformation</span>, fueled by the rapid rise of electric vehicles, the advent of autonomous driving technology, and the integration of Industry 4.0 manufacturing processes. Global supply chains are being re-engineered, while stringent sustainability mandates reshape every aspect of design, production, and distribution.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 flex items-center gap-4">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-slate-950 uppercase italic tracking-tighter">Key Threats</h3>
          </div>
            ...
            {threats.map((threat, idx) => (
              ...
              >
                <div className="h-52 overflow-hidden relative">
                  <img src={threat.image} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt={threat.title} />
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md p-2 rounded-xl shadow-md">
                    <AlertTriangle className="text-amber-500" size={24} />
                  </div>
                </div>
                <div className="p-8 flex-grow">
                  <h4 className="text-2xl font-bold text-slate-950 mb-4 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{threat.title}</h4>
                  <p className="text-slate-600 font-medium leading-relaxed">{threat.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-black text-slate-950 uppercase italic tracking-tighter">Comprehensive Protection</h3>
            </div>
      ...
      <section className="py-32 px-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-black mb-8 uppercase italic tracking-tighter">Secure Your <br /> Industrial Future</h2>
