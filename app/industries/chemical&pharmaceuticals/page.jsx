    ...
    >
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#0F172A] pt-32 pb-40">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-10">
            Vestigo Pharma Suite empowers chemical and pharmaceutical
            enterprises with advanced batch processing, quality assurance, and
            ...
            <div className="space-y-10">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Continuous monitoring of Environment, Health, and Safety
                    parameters with critical alert systems for plant safety.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Highly encrypted digital vaults designed to secure
                    intellectual property and proprietary chemical formulations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Paperless manufacturing workflows engineered to eliminate
                    human error and ensure GxP compliance.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-slate-950 text-white text-center border-t border-blue-600/30">
        ...
        <p className="text-slate-400 mb-10 max-w-2xl mx-auto text-lg leading-relaxed">
          Transform your chemical and pharmaceutical manufacturing operations
          with global safety standards and integrated GxP digital solutions.
        </p>
