      ...
      <section className="relative bg-[#020617] pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 text-blue-400 text-xs font-bold mb-8 border border-blue-400/20 uppercase tracking-widest">
            <Zap size={14} className="animate-pulse" /> Powering Global
            Infrastructure
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-2xl mb-12 leading-relaxed font-light">
            Providing high-precision renewable solutions through advanced
            hydro-integration, solar grid analytics, and carbon-neutral thermal
            systems.
          </p>
            ...
            {[
              {
                icon: <Droplets />,
                title: "Hydro Systems",
                desc: "Small to large scale hydroelectric turbine integration with smart flow control.",
              },
              {
                icon: <Sun />,
                title: "Solar Analytics",
                desc: "Real-time photovoltaic monitoring and predictive maintenance algorithms.",
              },
              {
                icon: <Battery />,
                title: "Storage Arrays",
                desc: "Liquid-cooled battery energy storage systems (BESS) for grid balancing.",
              },
            ].map((tech, i) => (
              <div
                key={i}
