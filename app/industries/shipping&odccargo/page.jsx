...
export default function ShippingODCPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg text-slate-400 max-w-xl mb-12 leading-relaxed font-light">
              Specializing in the impossible. From standard containers to
              complex Over Dimensional Cargo (ODC), we move the world's
              infrastructure.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {cargoTypes.map((cargo, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group p-10 bg-white border border-slate-100 rounded-2xl hover:border-blue-200 hover:shadow-2xl transition-all duration-500"
                >
      ...
      <section className="py-14 bg-white px-6 border-y border-slate-100">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="flex-1">
            <h2 className="text-5xl font-black text-slate-900 mb-8 leading-tight italic uppercase">
              Heavy Lift <br />
              <span className="text-blue-600 not-italic tracking-tighter">
                Engineering.
              </span>
            </h2>
            <div className="space-y-6">
              <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-200 group hover:border-blue-400 transition-colors">
                <div className="bg-blue-900 text-white p-3 rounded-xl h-fit">
                  <Maximize size={24} />
                </div>
                <div>
                  <h4 className="font-bold">Project Cargo Planning</h4>
                  <p className="text-sm text-slate-500 mt-1">
                    Route surveys and feasibility studies for oversized
                    equipment transport.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-200 group hover:border-blue-400 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Comprehensive insurance and real-time GPS tracking for
                    high-value assets.
                  </p>
                </div>
              </div>
          ...
          <div className="flex-1 bg-slate-900 p-12 rounded-[4rem] relative overflow-hidden group">
            ...
            <div className="relative z-10 border-l-4 border-blue-500 pl-8">
              <p className="text-white text-4xl font-black italic">
                500 <span className="text-xl">Metric Tons</span>
              </p>
