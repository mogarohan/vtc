...
const SuretyBondPage = () => {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative z-20 -mt-14 px-6 pb-24">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {cat.items.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 text-slate-700 text-xs font-bold uppercase tracking-wider"
                  >
      ...
      <section className="bg-slate-50 py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-black text-slate-900 mb-16 tracking-tighter uppercase">
            How It Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            {[
              {
                title: "Risk Analysis",
                desc: "Our specialists conduct a deep-dive evaluation of your operational and financial risk profile.",
              },
              {
                title: "Structuring",
                desc: "We engineer a customized bond or credit insurance policy tailored to your specific project needs.",
              },
              {
                title: "Digital Issuance",
                desc: "Fast-track policy issuance through our secure digital verification and underwriting platform.",
              },
            ].map((step, i) => (
      ...
      <section className="pb-32 px-6">
        <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3.5rem] p-16 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <p className="text-indigo-100 text-lg mb-10 max-w-2xl mx-auto relative z-10">
            Get expert guidance on surety bonds and credit insurance. Close your
            security gaps today.
          </p>
