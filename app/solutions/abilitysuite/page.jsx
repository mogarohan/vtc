      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto flex flex-col lg:row items-center gap-20">
          <div className="flex-1">
            <h2 className="text-4xl font-black text-slate-900 mb-8 tracking-tighter uppercase">
              Built for Modern Enterprise
            </h2>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Our modular architecture allows you to select only the specific
              components required for your operations, eliminating complex setup
              procedures.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="h-40 rounded-[2rem] bg-blue-50 border border-blue-100 flex flex-col items-center justify-center gap-2">
                  ...
                  <span className="font-black text-blue-600 text-xs tracking-widest uppercase">
                    Logic A
                  </span>
                </div>
                <div className="h-40 rounded-[2rem] bg-slate-50 border border-slate-100 flex flex-col items-center justify-center gap-2">
                  ...
                  <span className="font-black text-slate-400 text-xs tracking-widest uppercase">
                    Logic B
                  </span>
                </div>
              </div>
