...
export default function EmployeeBenefitsPage() {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1454165833767-1296b34922e3?q=80&w=800&auto=format&fit=crop",
    },
    {
      id: "step-3",
      num: "03",
      ...
      image:
        "https://images.unsplash.com/photo-1521791136064-7986c2923216?q=80&w=800&auto=format&fit=crop",
    },
    {
      id: "step-4",
      num: "04",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1600880212319-7524e2727928?q=80&w=800&auto=format&fit=crop",
    },
  ];
      ...
      <section className="relative pt-24 min-h-[85vh] flex items-center overflow-hidden bg-[#070B7F]">
        <div className="container mx-auto px-12 z-20 relative py-12 flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          <motion.div
            ...
            className="relative z-30 -mb-3 hidden lg:block"
          >
            <img
              src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop"
              className="rounded-[4rem] shadow-2xl border-8 border-white/5 grayscale hover:grayscale-0 transition-all duration-700 w-[800px]"
              alt="Team"
            />
          </motion.div>
        </div>
          ...
          {[
            {
              ...
              desc: "Comprehensive medical coverage ensures employees have access to quality healthcare, enhancing well-being and reducing absenteeism.",
            },
            {
              title: "Group Life Insurance",
              icon: <Wallet className="w-10 h-10 text-blue-500" />,
              desc: "Essential financial protection for employees’ families in unforeseen circumstances, providing peace of mind and security.",
            },
            {
              title: "Gratuity Insurance",
              icon: <Smile className="w-10 h-10 text-purple-500" />,
              desc: "Safeguards end-of-service benefits, ensuring financial stability for employees while meeting employer obligations.",
            },
            {
              title: "Group Personal Accident",
              icon: <Umbrella className="w-10 h-10 text-orange-500" />,
              desc: "24/7 accident coverage protecting your workforce against unexpected events and reinforcing a secure working environment.",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
            ...
            >
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4 text-[#070B7F]">
                {item.title}
              </h3>
          ...
          <div className="flex flex-col gap-32 relative z-10">
            {processSteps.map((step, i) => (
              <div
                key={i}
                id={step.id}
                className={`flex items-center justify-between w-full ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} flex-col md:flex-row gap-12`}
              >
                {/* CONTENT CARD */}
                <motion.div
                ...
                >
                  <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl shadow-blue-900/5 border border-slate-100 relative group overflow-hidden">
                    <div className="flex justify-between items-center mb-8">
                      <div className="text-blue-600 p-4 bg-blue-50 rounded-2xl group-hover:bg-[#070B7F] group-hover:text-white transition-all duration-500">
                        {step.icon}
                      </div>
                    ...
                    <h3 className="text-3xl font-black uppercase tracking-tighter text-[#070B7F] mb-6">
                      {step.title}
                    </h3>
                ...
                >
                  <div
                    className={`flex ${i % 2 === 0 ? "justify-start" : "justify-end"} px-8`}
                  >
                    <div className="relative w-full max-w-sm aspect-video overflow-hidden rounded-[2.5rem] shadow-2xl border-4 border-white group bg-slate-200">
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src =
                            "https://images.unsplash.com/photo-1557683311-eac922347aa1?q=80&w=800";
                        }}
                      />
