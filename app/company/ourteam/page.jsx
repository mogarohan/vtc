...
export default function OurTeam() {
            ...
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <p className="text-base sm:text-lg md:text-2xl text-white leading-relaxed font-bold border-l-4 border-blue-600 pl-4 md:pl-6">
                  Vestigo is guided by leadership that combines deep insurance expertise, disciplined judgment, and genuine responsibility toward clients. Our founders remain closely involved in advisory and client engagements.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5">
              <motion.h3 {...fadeInUp} className="text-5xl font-bold text-slate-900 mb-8">Our Team
              <div className="w-30 h-1.5 bg-blue-600 mb-5 mt-2 ml-8 rounded-full" /></motion.h3>
              <motion.p {...fadeInUp} className="text-gray-600 text-xl leading-relaxed">
                At Vestigo, our team works with a clear sense of responsibility—because insurance 
                is not about paperwork, it is about standing by clients when outcomes matter most.
              </motion.p>
            </div>
            ...
            <div className="lg:col-span-7 grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="leading-relaxed text-blue-50/80 text-lg">
                  We take the time to understand each client's business, risks, and expectations, 
                  ensuring our advice is thoughtful, practical, and dependable.
                </p>
              </motion.div>
              ...
              >
                <h3 className="text-2xl font-bold text-slate-900 mb-6">Continuous Partnership</h3>
                <p className="text-gray-600 leading-relaxed text-lg">
                  Our teams remain engaged across the entire insurance journey, providing 
                  continuity, clarity, and support—not just at placement, but through 
                  claims and critical moments.
                </p>
              </motion.div>
            </div>
          </div>
    ...
    >
      <div className="bg-white p-12 rounded-[1.9rem] flex flex-col md:flex-row items-center gap-8">
        ...
        <p className="italic text-slate-800 text-2xl md:text-3xl font-medium leading-tight text-center md:text-left">
          Clients rely on Vestigo because we understand that true partnership means 
          being there when it matters—with expertise, integrity, and genuine care.
        </p>
      </div>
    </motion.div>
  </div>
      ...
      <section className="py-5 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold text-slate-900">Our Leadership</h2>
          ...
          <div className="space-y-30">
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              >
                <Image src="/member1.jpg" alt="Bhavit Acharya" fill className="object-cover" />
              </motion.div>
              <div className="lg:w-2/3">
                <span className="text-blue-600 font-bold tracking-widest uppercase text-sm">Director & Principal Officer</span>
                <h3 className="text-4xl font-bold text-slate-900 mt-2 mb-4">Bhavit Acharya</h3>
                ...
                <div className="flex gap-4">
                  {[Linkedin, Instagram, Mail].map((Icon, i) => (
                    <a key={i} href="#" className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-blue-600 hover:text-white transition-all">
                      <Icon size={20} />
                    </a>
                  ))}
                </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
              <motion.div 
                ...
                className="relative w-full lg:w-1/3 aspect-[3/4] rounded-[3rem] overflow-hidden shadow-2xl"
              >
                <Image src="/member2.png" alt="Riya Shah" fill className="object-cover" />
              </motion.div>
              <div className="lg:w-2/3 lg:text-right">
                ...
                <h3 className="text-4xl font-bold text-slate-900 mt-2 mb-4">Riya Shah</h3>
                <p className="inline-block bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-sm font-bold mb-6">
      ...
      <section className="bg-slate-950 py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <br />
            <span className="text-blue-500">Committed to standing with clients.</span>
          </motion.h3>
        </div>
      </section>
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    <div className="text-center mb-16">
      <h2 className="text-4xl font-bold text-slate-900 tracking-tight">What Drives Us</h2>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {values.map((val, i) => (
        ...
        >
          ...
          <div className="relative z-10">
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-inner ${val.color} bg-white group-hover:scale-110 transition-transform duration-500`}>
              {val.icon}
            </div>
      ...
      <section className="pb-10 px-6">
        ...
        >
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8">Want to join our mission?</h2>
